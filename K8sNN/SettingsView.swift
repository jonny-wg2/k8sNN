            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                VStack(spacing: 12) {
                    ...
                    HStack {
                        ...
                        Text("\(Int(settingsManager.multiClusterWindowWidth))px")
                            .font(.caption)
                            .foregroundStyle(.secondary)
                    ...
                    HStack {
                        ...
                        Text("\(Int(settingsManager.multiClusterWindowHeight))px")
                            .font(.caption)
                            .foregroundStyle(.secondary)
                            .frame(width: 60, alignment: .trailing)
                    }
                    ...
                    HStack {
                        ...
                        Button("Reset to Default") {
                            settingsManager.multiClusterWindowWidth = 1000
                            settingsManager.multiClusterWindowHeight = 700
                            settingsManager.saveSettings()
                        }
                        .font(.caption)
                        .foregroundStyle(.blue)
